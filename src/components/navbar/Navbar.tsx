...
const Navbar = () => {
    ...
    return (
        <>
            <nav className="flex justify-between text-xs relative">
                <h1 className="logo text-2xl font-medium flex  items-center  gap-1 cursor-pointer">
...
const MobileNavMenu = ({ closeNavMenu }: { closeNavMenu: () => void }
    ...
    return (
        <div className='w-[100%] md:hidden border border-black z-10 bg-white'>
            <div className='flex justify-end   text-end'>
                <IoCloseSharp className='text-end rounded-md ' onClick={closeNavMenu} />

            </div>
            <div className='text-xs mb-2'>
                <ul className='flex flex-col gap-2 text-black items-center '>
                    <li className='p-1 rounded-md cursor-pointer'>Home</li>
                    <li className='p-1 rounded-md  cursor-pointer' onClick={toggleDropdownVisibility} >
                        <div className='flex items-center gap-1'>
                        ...
                        {dropdownVisibility ?
                            <div className='bg-slate-50'>
                                <ul className='text-center bg-slate-50'>
                                    <li className='cursor-pointer border-b hover:border-dashed'>Men</li>
                                    <li className='cursor-pointer border-b hover:border-dashed'>Women</li>
                                    <li className='cursor-pointer border-b hover:border-dashed'>Unisex</li>
                                </ul>
                            </div>
                            : null}
                    </li>
                    <li className='p-1 rounded-md cursor-pointer'>Our Story</li>
                    <li className='p-1 rounded-md cursor-pointer'>About</li>
                    <li className='p-1 rounded-md cursor-pointer'>Contact Us</li>
                </ul>
            </div>
